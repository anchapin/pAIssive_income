...
class MockHuggingFaceHub:
    ...
    def add_repo(self, repo_info: Union[MockRepoInfo, Dict[str, Any]]) -> None:
        ...
        if "/" in repo_info.id:
            if repo_info.pipeline_tag or "model" in repo_info.tags:
        ...
        **kwargs
        ...
        for model_id, model_info in self.models.items():
            ...
            if search:
                ...
                if (search_lower not in model_id.lower() and
                    search_lower not in model_info.author.lower() and
                    not any(search_lower in tag.lower() for tag in model_info.tags)):
                    continue
