...
class TestRevenueAnalytics:
    ...
    def test_mrr_movements(self):
        ...
        with patch.object(self.revenue_analytics, "get_subscription_events") as mock_events:
            ...
            period_events = [
                e for e in self.subscription_events
    ...
    def test_churn_analysis(self):
        ...
        with patch.object(self.churn_analyzer, "get_subscription_data") as mock_subs:
            ...
            churn_reasons = {
                "sub_004": "Price too high",
                "sub_005": "Missing features"
            }
            ...
            with patch.object(self.churn_analyzer, "predict_churn_risk") as mock_predict:
                mock_predict.side_effect = lambda customer_id: churn_risk_factors.get(customer_id, 0.0)
                ...
                with patch.object(self.churn_analyzer, "get_prevention_strategies") as mock_strategies:
                    mock_strategies.side_effect = lambda customer_id: prevention_strategies.get(customer_id, [])
