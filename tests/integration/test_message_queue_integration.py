...
class TestMessageQueueIntegration:
    ...
    def test_service_communication(self):
        ...
        consumers = {
            service: MessageConsumer(self.config) for service in services
        }
        
        # Create a publisher for each service
        publishers = {
            service: MessagePublisher(self.config) for service in services
        }
        ...
        for msg in test_messages:
            ...
            # Verify headers
            matching_messages = [
                received for received in received_messages[target_service]
