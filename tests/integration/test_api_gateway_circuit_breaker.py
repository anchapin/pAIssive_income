...
class TestAPIGatewayCircuitBreaker:
    ...
    def test_circuit_breaker_integration(self):
        ...
        with patch(
            ...
            with patch(
                ...
                assert (
                    self.circuit_breaker.get_state("user-service") == CircuitState.OPEN
                )
                ...
                assert (
                    self.circuit_breaker.get_state("user-service")
    ...
    def test_multiple_service_failures(self):
        ...
        with patch(
            ...
            assert (
                self.circuit_breaker.get_state("order-service") == CircuitState.CLOSED
            )
    ...
    def test_partial_failures(self):
        ...
        with patch(
            ...
            assert (
                self.circuit_breaker.get_state("product-service") != CircuitState.OPEN
            )
