...
def fake_mem0_result():
    ...
    return [
        {"text": "Project deadline is next Friday", "relevance": 0.9, "timestamp": 1704110400},  # 2024-01-01T10:00:00Z as Unix timestamp
        {"text": "Remember to update the documentation", "relevance": 0.7, "timestamp": 1704106800},  # 2024-01-01T09:00:00Z as Unix timestamp
    ]
...
def fake_chroma_result():
    ...
    return [
        {"text": "Unified answer 1", "relevance": 0.8, "timestamp": 1704103200},  # 2024-01-01T08:00:00Z as Unix timestamp
        {"text": "Unified answer 2", "relevance": 0.6, "timestamp": 1704099600},  # 2024-01-01T07:00:00Z as Unix timestamp
    ]
...
def test_integration_with_memory_enhanced_team():
    ...
    with patch.object(MemoryRAGCoordinator, "query", return_value=fake_merged_result):
        # Create a team instance for testing
        team = MemoryEnhancedCrewAIAgentTeam(user_id="test_user")
