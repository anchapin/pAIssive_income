...
def sqlite_db():
    ...
    assert final_counter <= expected_counter, f"Final counter: {final_counter}, Expected: {expected_counter}"
    ...
    assert total_records == expected_records, f"Total records: {total_records}, Expected: {expected_records}"
    ...
    assert thread_records == items_per_thread, f"Thread {i} records: {thread_records}, Expected: {items_per_thread}"
