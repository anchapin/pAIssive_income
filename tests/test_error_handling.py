...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_http_status_mapping(self):
        ...
        self.assertEqual(
            get_status_code_for_exception(ValueError()),
            HTTPStatus.BAD_REQUEST
        )
        self.assertEqual(
            get_status_code_for_exception(FileNotFoundError()),
            HTTPStatus.NOT_FOUND
        )
        self.assertEqual(
            get_status_code_for_exception(PermissionError()),
        ...
        self.assertEqual(
            get_status_code_for_exception(validation_error),
            HTTPStatus.BAD_REQUEST
        )
