...
class TestMarketTrendAnalysis:
    ...
    def test_historical_trend_analysis(self):
        ...
        seasonal_patterns = self.historical_analyzer.analyze_seasonality(
            historical_data
        )
        ...
        long_term_trends = self.historical_analyzer.analyze_long_term_trends(
            historical_data
        )
        ...
        assert long_term_trends["trend_type"] in [
            "linear",
            "exponential",
            "cyclical",
            "random",
