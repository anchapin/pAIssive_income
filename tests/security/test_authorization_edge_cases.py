...
class TestAuthorizationEdgeCases:
    ...
    def test_inherited_permissions_basic(self):
        ...
        self.assertTrue(self.permission_service.has_permission(admin_data, "read"))  # user permission
        self.assertTrue(self.permission_service.has_permission(admin_data, "write"))  # manager permission
        self.assertTrue(self.permission_service.has_permission(admin_data, "manage_team"))  # manager permission
        self.assertTrue(self.permission_service.has_permission(admin_data, "delete"))  # admin permission
        self.assertTrue(self.permission_service.has_permission(admin_data, "manage_users"))  # admin permission
        ...
        self.assertTrue(self.permission_service.has_permission(manager_data, "read"))  # user permission
        self.assertTrue(self.permission_service.has_permission(manager_data, "write"))  # manager permission
        self.assertTrue(self.permission_service.has_permission(manager_data, "manage_team"))  # manager permission
        self.assertFalse(self.permission_service.has_permission(manager_data, "delete"))  # admin permission
        self.assertFalse(self.permission_service.has_permission(manager_data, "manage_users"))  # admin permission
    ...
    def test_inherited_permissions_with_overrides(self):
        ...
        self.assertTrue(self.permission_service.has_permission(admin_data, "limited_write"))  # from user
        self.assertTrue(self.permission_service.has_permission(admin_data, "limited_delete"))  # from manager
        ...
        self.assertTrue(self.permission_service.has_permission(manager_data, "read"))
        self.assertTrue(self.permission_service.has_permission(manager_data, "write"))
        self.assertTrue(self.permission_service.has_permission(manager_data, "limited_write"))  # from user
        self.assertTrue(self.permission_service.has_permission(manager_data, "limited_delete"))  # manager override
        self.assertFalse(self.permission_service.has_permission(manager_data, "delete"))  # admin only
    ...
    def test_temporary_permission_elevation_expiry(self):
        ...
        self.assertTrue(self.permission_service.has_permission(user_data, "temporary_admin"))  # elevated
        
        # Wait for elevation to expire
        time.sleep(3)
        
        # Verify elevated permissions have expired
        self.assertTrue(self.permission_service.has_permission(user_data, "read"))  # still from role
        self.assertFalse(self.permission_service.has_permission(user_data, "write"))  # expired
        self.assertFalse(self.permission_service.has_permission(user_data, "temporary_admin"))  # expired
    ...
    def test_temporary_permission_elevation_with_approval(self):
        ...
        self.assertTrue(self.permission_service.has_permission(elevated_data, "temporary_admin"))  # elevated
