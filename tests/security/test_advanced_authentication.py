...
(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.session_store.invalidate_all_user_sessions.side_effect = self._mock_invalidate_all_user_sessions
    ...
    def test_concurrent_authentication_rate_limiting(self):
        ...
        def mock_check_rate_limit(ip_address):
            ...
            ip_attempts[ip_address] = [t for t in ip_attempts[ip_address] 
    ...
    def test_session_invalidation_all_user_sessions(self):
        ...
        users = {
            "123": ["session1", "session2", "session3"],
            "456": ["session4", "session5"]
        }
