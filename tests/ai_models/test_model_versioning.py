...
from ai_models.model_versioning import ModelVersion, ModelVersionRegistry, VersionedModelManager, ModelMigrationTool
...
def test_concurrent_version_updates(version_registry, model_info):
    ...
    update1 = ModelVersion(
        version="1.1.0",
        model_id=model_info.id,
        features=["base-feature", "feature-a"]
    )
    update2 = ModelVersion(
        version="1.1.0",
        model_id=model_info.id,
        features=["base-feature", "feature-b"]
    )
