...
class TestWebhookSignatureVerifier:
    ...
    def test_verify_signature(self):
        ...
        assert WebhookSignatureVerifier.verify_signature(secret, payload + "modified", signature) is False
        assert WebhookSignatureVerifier.verify_signature("different-secret", payload, signature) is False
        assert WebhookSignatureVerifier.verify_signature(secret, payload, signature + "modified") is False
    ...
    def test_verify_request_signature(self):
        ...
        assert WebhookSignatureVerifier.verify_request_signature(secret, payload, headers_missing) is False
        ...
        assert WebhookSignatureVerifier.verify_request_signature(secret, payload, headers_invalid) is False
