...
from tests.api.utils.test_data import (
    generate_id, generate_niche_analysis_data, generate_monetization_data,
    generate_marketing_strategy_data, generate_agent_team_data
)
...
class TestAPIIntegration:
    ...
    def test_api_key_authentication(self, api_test_client: APITestClient, auth_api_test_client: APITestClient):
