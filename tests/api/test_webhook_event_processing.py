    ...
    async def test_payload_validation(self):
        ...
        try:
            ...
            with patch("httpx.AsyncClient.post", return_value=success_response):
                ...
                invalid_data = {
                    "username": "testuser"  # Missing user_id
                }
    ...
    async def test_event_correlation(self):
        ...
        try:
            ...
            with patch("httpx.AsyncClient.post", mock_post):
                ...
                user_events = [e for e in delivered_events if e["type"] == WebhookEventType.USER_CREATED]
                payment_events = [e for e in delivered_events if e["type"] == WebhookEventType.PAYMENT_RECEIVED]
