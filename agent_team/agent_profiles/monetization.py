...
class MonetizationAgent:
    ...
    def _create_monetization_strategy(self, niche: Dict[str, Any], solution: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        def calculate_revenue(users):
            ...
            return basic_monthly + basic_yearly + pro_monthly + pro_yearly + premium_monthly + premium_yearly
    ...
    def analyze_pricing_sensitivity(self, niche: Dict[str, Any], strategy: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "competitor_analysis": {
                ...
                "highest_competitor_price": strategy["subscription_tiers"][2]["price_monthly"] * 1.3,
                "average_competitor_price": strategy["subscription_tiers"][1]["price_monthly"] * 0.9,
            },
            "recommendations": {
