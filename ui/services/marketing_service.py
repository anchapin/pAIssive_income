    ...
    def _create_mock_campaign(self, solution: Dict[str, Any]) -> Dict[str, Any]:
        ...
        channels = [
            ...
            },
            {
                ...
                'content_types': ['Tips and tricks', 'Success stories', 'Product updates'],
            ...
            },
            {
                ...
                'content_types': ['Newsletters', 'Product announcements', 'Tips and resources'],
        ...
        return {
            ...
            'channel_strategy': {
                ...
                'budget': {
                    'total': '$5000',
                    'allocation': {channel['name']: channel['budget_allocation'] for channel in channels}
                }
            },
            'content_strategy': {
                'themes': [
            ...
            'kpis': {
                'awareness': ['Website traffic', 'Social media followers', 'Email subscribers'],
