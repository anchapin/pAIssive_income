...
class TestDetectCIEnvironment(unittest.TestCase):
    ...
    def test_safe_file_exists(self) -> None:
    ...
    def test_safe_read_file(self) -> None:
    ...
    def test_detect_os_environment(self) -> None:
    ...
    def test_detect_wsl_environment(self, mock_system) -> None:
    ...
    def test_detect_github_actions_environment(self) -> None:
    ...
    def test_detect_jenkins_environment(self) -> None:
    ...
    def test_detect_gitlab_ci_environment(self) -> None:
    ...
    def test_detect_ci_with_type_and_platform(self) -> None:
    ...
    def test_detect_docker_environment(self, mock_read_file, mock_file_exists) -> None:
    ...
    def test_detect_docker_environment_from_env(self) -> None:
    ...
    def test_detect_kubernetes_environment(self) -> None:
    ...
    def test_detect_docker_compose_environment(self) -> None:
    ...
    def test_detect_docker_swarm_environment(self) -> None:
    ...
    def test_detect_podman_environment(self) -> None:
    ...
    def test_detect_lxc_environment(self) -> None:
    ...
    def test_detect_containerd_environment(self) -> None:
