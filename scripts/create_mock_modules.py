...
def create_mock_mcp_module() -> bool:
    ...
    try:
        ...
        logger.exception(f"❌ Failed to create mock MCP module: {e}")
        return False
...
def create_mock_crewai_module() -> bool:
    ...
    try:
        ...
        logger.exception(f"❌ Failed to create mock CrewAI module: {e}")
        return False
...
def create_mock_mem0_module() -> bool:
    ...
    try:
        ...
        logger.exception(f"❌ Failed to create mock mem0 module: {e}")
        return False
...
''')
        ...
        logger.exception(f"❌ Failed to create physical mock modules: {e}")
        return False
