...
if STRAWBERRY_AVAILABLE:
    ...
    class AgentTeamQuery:
        ...
        @strawberry.field
        def agent_conversations(self, info: Info, team_id: Optional[strawberry.ID] = None) -> List[AgentConversation]:
            """
    ...
    class AgentTeamMutation:
        ...
        @strawberry.mutation
        async def send_message_to_team(self, info: Info, input: SendMessageInput) -> AgentConversation:
            """
