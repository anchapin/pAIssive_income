...
if STRAWBERRY_AVAILABLE:
    ...
    class AIModelsQuery:
        ...
        @strawberry.field
        def model_inference_history(self, info: Info, limit: int = 10) -> List[ModelInferenceResult]:
            """
    ...
    class AIModelsMutation:
        ...
        @strawberry.mutation
        async def generate_text(self, info: Info, input: TextGenerationInput) -> TextGenerationResult:
            """
        ...
        @strawberry.mutation
        async def classify_text(self, info: Info, input: TextClassificationInput) -> TextClassificationResult:
            """
