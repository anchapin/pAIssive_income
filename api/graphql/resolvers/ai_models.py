...
if STRAWBERRY_AVAILABLE:
    from ..schemas.ai_models import (
        ModelType, ModelVersionType, ModelMetricsType, InferenceRequestType, InferenceResponseType,
        ModelInput, InferenceInput, ModelTypeEnum
    )
    ...
    class AIModelsQuery:
        ...
        @strawberry.field
        async def models(self, info: Info, model_type: Optional[ModelTypeEnum] = None,
                       limit: Optional[int] = 10, offset: Optional[int] = 0) -> List[ModelType]:
            """
    ...
    class AIModelsMutation:
        ...
        @strawberry.mutation
        async def run_inference(self, info: Info, input: InferenceInput) -> Optional[InferenceResponseType]:
            """
