...
class WebhookCreate(BaseModel):
    ...
    secret: Optional[str] = Field(
        None, description="Secret used to sign the webhook payload"
    )
...
class WebhookResponse(BaseModel):
    ...
    updated_at: Optional[str] = Field(
        None, description="Timestamp when the webhook was last updated"
    )
    secret_set: bool = Field(
        ..., description="Whether a secret is set for this webhook"
    )
