...
class APIKeyCreate(BaseModel):
    ...
    scopes: List[str] = Field(default_factory=list, description="Scopes (permissions) for the API key")
...
class APIKeyUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Description of the API key")
    expires_at: Optional[datetime] = Field(None, description="Expiration date of the API key")
    scopes: Optional[List[str]] = Field(None, description="Scopes (permissions) for the API key")
    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {
                ...
                "scopes": ["read:niche_analysis", "write:niche_analysis", "read:monetization"],
                "is_active": True
            }
        }
