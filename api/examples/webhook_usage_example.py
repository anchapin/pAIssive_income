...
class NicheAnalysisService:
    ...
    async def run_niche_analysis(self, analysis_id: str, niche: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            results = {
                ...
                "keywords": [
                    {"keyword": "best budget gaming laptop", "volume": 12000, "difficulty": "Medium"},
                    {"keyword": "gaming laptop under 1000", "volume": 8500, "difficulty": "Medium-High"},
                    {"keyword": "affordable gaming laptop reviews", "volume": 5500, "difficulty": "Low"}
                ]
            }
