...
async def register_user(data: UserRegisterRequest = Body(...)):
    ...
    data: UserProfileUpdateRequest, token: str = Depends(verify_token)
    ):
    ...
    data: PasswordChangeRequest, token: str = Depends(verify_token)
    ):
    ...
    data: UserSettingsUpdateRequest, token: str = Depends(verify_token)
    ):
