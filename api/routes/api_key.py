...
async def update_api_key(
    ...
    try:
        ...
        if api_key.user_id != current_user.get("id"):
            raise HTTPException(
                status_code=403, detail="Not authorized to update this API key"
            )
...
async def revoke_api_key(
    ...
    try:
        ...
        if api_key.user_id != current_user.get("id"):
            raise HTTPException(
                status_code=403, detail="Not authorized to revoke this API key"
            )
...
async def regenerate_api_key(
    ...
    try:
        ...
        if api_key.user_id != current_user.get("id"):
            raise HTTPException(
                status_code=403, detail="Not authorized to regenerate this API key"
            )
