...
class AuditService:
    ...
    def __init__(self, storage_path: str = None):
        ...
        """
        self.storage_path = storage_path or os.path.join(os.path.dirname(__file__), "../data/audit_logs.json")
    ...
    def record_event(self, event: AuditEvent) -> AuditEvent:
        ...
        # Log the event
        logger.info(f"Audit event recorded: {event.event_type} - {event.action} - {event.resource_type}/{event.resource_id}")
