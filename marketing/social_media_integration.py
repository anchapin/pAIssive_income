...
SUPPORTED_PLATFORMS = {
    SocialMediaPlatform.TWITTER: {
        "name": "Twitter",
        "capabilities": [
            "post_text", "post_media", "analytics", "audience_insights", "scheduling"
        ],
    ...
    SocialMediaPlatform.FACEBOOK: {
        "name": "Facebook",
        "capabilities": [
            "post_text", "post_media", "post_link", "analytics", "audience_insights", "scheduling"
        ],
    ...
    SocialMediaPlatform.INSTAGRAM: {
        "name": "Instagram",
        "capabilities": [
            "post_media", "post_story", "analytics", "audience_insights"
        ],
    ...
    SocialMediaPlatform.LINKEDIN: {
        "name": "LinkedIn",
        "capabilities": [
            "post_text", "post_media", "post_article", "analytics", "audience_insights", "scheduling"
        ],
    ...
    SocialMediaPlatform.YOUTUBE: {
        "name": "YouTube",
        "capabilities": [
            "post_video", "analytics", "audience_insights", "scheduling"
        ],
    ...
    SocialMediaPlatform.PINTEREST: {
        "name": "Pinterest",
        "capabilities": [
            "post_pin", "analytics", "audience_insights", "scheduling"
        ],
    ...
    SocialMediaPlatform.TIKTOK: {
        "name": "TikTok",
        "capabilities": [
            "post_video", "analytics", "audience_insights"
        ],
...
class SocialMediaIntegration(ISocialMediaIntegration):
    ...
    def connect_platform(
        ...
        try:
            ...
            self.connections[connection_id].update({
                "account_name": verified_connection.get("account_name", connection["account_name"]),
                "account_id": verified_connection.get("account_id", connection["account_id"]),
                "profile_url": verified_connection.get("profile_url", connection["profile_url"]),
                "verified": True
            })
    ...
    def delete_post(
        ...
        # Check if we have the post locally
        post_exists_locally = (
            platform_id in self.posts and 
            post_id in self.posts[platform_id]
        )
