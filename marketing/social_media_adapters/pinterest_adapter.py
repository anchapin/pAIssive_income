...
class PinterestAdapter(BaseSocialMediaAdapter):
    ...
    def validate_content(self, content: Dict[str, Any]) -> bool:
        ...
        if source_type == "image_base64" and "base64" not in pin["media"]:
            raise ContentValidationError(
                "pinterest",
                "Base64 data is required for image_base64 source type"
            )
    ...
    def _find_or_create_board(self, board_name: str) -> str:
        ...
        try:
            ...
            raise PostingError("pinterest", f"Failed to find or create board '{board_name}': {str(e)}")
        ...
        try:
            ...
            if not metrics:
                metrics = [
                    ...
                    "VIDEO_VIEW", "ENGAGEMENT", "ENGAGEMENT_RATE"
                ]
