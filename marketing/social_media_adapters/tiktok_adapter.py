...
class TikTokAdapter(BaseSocialMediaAdapter):
    ...
    def validate_content(self, content: Dict[str, Any]) -> bool:
        ...
        if "video" not in content:
            raise ContentValidationError(
                "tiktok", 
                "Video is required for TikTok posts"
            )
    ...
    def post_content(
        ...
        try:
            ...
            if not self.access_token or not self.open_id:
                raise PostingError("tiktok", "Access token and open_id are required for posting videos")
    ...
    def schedule_post(
        ...
        try:
            # Check if we have an access token (required for posting)
            if not self.access_token or not self.open_id:
                raise SchedulingError("tiktok", "Access token and open_id are required for scheduling videos")
    ...
    def get_post(self, post_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not self.access_token or not self.open_id:
                raise PostingError("tiktok", "Access token and open_id are required for getting video details")
    ...
    def delete_post(self, post_id: str) -> bool:
        ...
        try:
            ...
            if not self.access_token or not self.open_id:
                raise DeletionError("tiktok", "Access token and open_id are required for deleting videos")
    ...
    def get_audience_insights(
        ...
        try:
            ...
            if not self.access_token or not self.open_id:
                raise PostingError("tiktok", "Access token and open_id are required for audience insights")
