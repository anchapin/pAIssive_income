...
class TestWebhookSecurityIntegration(unittest.TestCase):
    ...
    def test_signature_verification(self):
        ...
        self.assertFalse(WebhookSignatureVerifier.verify_signature(secret, payload, invalid_signature))
        
        # Test invalid payload
        modified_payload = payload + "modified"
        self.assertFalse(WebhookSignatureVerifier.verify_signature(secret, modified_payload, signature))
    ...
    def test_security_integration(self):
        ...
        can_proceed = (
            ip_allowlist.is_allowed(client_ip) and
            not rate_limiter.is_rate_limited(request_key) and
