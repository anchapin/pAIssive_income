...
class WebhookSignatureVerifier:
    ...
    secret, payload, invalid_signature
    )
    )
    ...
    self.assertFalse(
    WebhookSignatureVerifier.verify_signature(
    secret, modified_payload, signature
    )
    )
    ...
    # Verify signature
    is_valid = WebhookSignatureVerifier.verify_request_signature(
    ...
    and WebhookSignatureVerifier.verify_request_signature(
    secret, payload, headers
    )
    )
