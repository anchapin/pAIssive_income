...
class PaymentProcessorFactory:
    ...
    def register_processor(self, processor_type: str, processor_class: Type[PaymentProcessor]) -> None:
        """
    ...
    def register_processor_from_module(self, processor_type: str, module_name: str, class_name: str) -> None:
        """
        ...
        try:
            ...
            raise ValueError(f"Failed to load payment processor class {class_name} from module {module_name}: {e}")
