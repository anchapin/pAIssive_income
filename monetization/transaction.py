...
class Transaction:
    ...
    def update_status(self, status: str, reason: Optional[str] = None) -> None:
        ...
        if status in [TransactionStatus.SUCCEEDED, TransactionStatus.FAILED] and not self.processed_at:
    ...
    def is_refundable(self) -> bool:
        ...
        if self.status not in [TransactionStatus.SUCCEEDED, TransactionStatus.PARTIALLY_REFUNDED]:
            return False
