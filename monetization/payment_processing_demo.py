...
def run_demo():
    ...
    print(f"Card: {payment_method['details']['masked_number']} ({payment_method['details']['brand']})")
    print(f"Expiration: {payment_method['details']['exp_month']}/{payment_method['details']['exp_year']}")
    print_separator()
    ...
    for payment in payments:
        print(f"- {payment['id']}: {processor.format_amount(payment['amount'], payment['currency'])} ({payment['status']})")
