...
def test_freemium_model():
    ...
    # Add paid tiers
    tier1 = model.add_paid_tier(name="Tier 1", description="Test tier 1", price_monthly=9.99)

    tier2 = model.add_paid_tier(name="Tier 2", description="Test tier 2", price_monthly=19.99)
