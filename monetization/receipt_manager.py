...
class ReceiptManager:
    ...
    def get_customer_receipts(
        ...
        for receipt_id in self.customer_receipts[customer_id]:
            ...
            if start_date and receipt.date < start_date:
                continue
            
            if end_date and receipt.date > end_date:
                continue
    ...
    def delete_receipt(self, receipt_id: str) -> bool:
        ...
        if self.storage_dir:
            file_path = os.path.join(self.storage_dir, f"{receipt_id}.json")
    ...
    def _save_receipt(self, receipt: Receipt) -> None:
        ...
        file_path = os.path.join(self.storage_dir, f"{receipt.id}.json")
