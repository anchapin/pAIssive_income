...
class OpportunityScorer:
    ...
    def score_opportunity(
        ...
        market_bonus = 0.2 if factor_scores["market_size"] >= 0.8 else 0.1 if factor_scores[
            "market_size"
        ] >= 0.6 else -0.1
        growth_bonus = 0.2 if factor_scores["growth_rate"] >= 0.8 else 0.1 if factor_scores[
            "growth_rate"
        ] >= 0.6 else -0.1
