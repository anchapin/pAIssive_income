...
(BaseModel):
    ...
    severity: str = Field(
    ..., description="Severity of the problem (high, medium, low)"
    )
    ...
    ..., description="Weighted score for the factor", ge=0.0, le=1.0
    )
    ...
    ..., description="Market size factor score", ge=0.0, le=1.0
    )
    growth_rate: float = Field(
    ..., description="Growth rate factor score", ge=0.0, le=1.0
    )
    competition: float = Field(
    ..., description="Competition factor score", ge=0.0, le=1.0
    )
