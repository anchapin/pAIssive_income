...
import threading
import asyncio
from typing import Dict, Any, Optional, List, Union, Callable, Set, Pattern, Tuple
...
from .event import Event, EventType, EventHandler, AsyncEventHandler
from .exceptions import EventPublishError, EventSubscribeError, EventHandlingError
...
class EventSubscriber:
    ...
    def subscribe(
        ...
        try:
            ...
            logger.info(f"Created subscription {subscription.subscription_id} for pattern {event_pattern}")
                ...
                try:
                    ...
                    for subscription in matching_subscriptions:
                        try:
                            ...
                            logger.error(f"Error handling event {event.name} in subscription {subscription.subscription_id}: {str(e)}")
