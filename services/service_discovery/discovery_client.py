...
class ServiceDiscoveryClient:
    ...
    def __init__(
        ...
        self.registry = ConsulServiceRegistry(host=registry_host, port=registry_port)
    ...
    def _setup_load_balancer(self, strategy_name: str) -> None:
        ...
        self.load_balancer.filter_function = (
            lambda instance: self.registry.get_service_health(instance.service_id)
        )
    ...
    def with_service(
        self, service_name: str, fallback_url: Optional[str] = None
