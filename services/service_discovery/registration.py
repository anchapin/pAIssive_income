...
from services.service_discovery.helpers import setup_service_discovery, register_health_check_endpoint
...
class ServiceRegistration:
    ...
    def __init__(
        ...
        try:
            self.registry_port = registry_port or int(os.environ.get("SERVICE_REGISTRY_PORT", "8500"))
        except ValueError:
    ...
    def register(self) -> bool:
        ...
        """
        try:
            logger.info(f"Registering service {self.service_name} at {self.registry_host}:{self.registry_port}")
    ...
    def setup_health_check(self, app, check_functions: Optional[List[Callable[[], bool]]] = None) -> None:
        """
