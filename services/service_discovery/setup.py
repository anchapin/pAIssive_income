...
if __name__ == "__main__":
    ...
    start_parser.add_argument("--no-server", action="store_false", dest="server", help="Disable server mode")
    start_parser.add_argument("--no-dev", action="store_false", dest="dev_mode", help="Disable dev mode")
    ...
    config_parser.add_argument("--client-addr", default="0.0.0.0", help="Client address")
    config_parser.add_argument("--no-server", action="store_false", dest="server", help="Disable server mode")
    config_parser.add_argument("--no-bootstrap", action="store_false", dest="bootstrap", help="Disable bootstrap mode")
