...
def setup_service_discovery(
    ...
    logger.info(f"Setting up service discovery for {service_name} at {registry_host}:{registry_port}")
...
def get_service_url(service_name: str, path: str = "/", client: Optional[ServiceDiscoveryClient] = None) -> Optional[str]:
    """
