...
class ModelServicer:
    ...
    def GenerateText(self, request, context):
        ...
        try:
            ...
            completion_tokens = self.tokenizer(result["text"], return_tensors="pt").input_ids.shape[1]
    ...
    def GenerateChatCompletion(self, request, context):
        ...
        try:
            ...
            completion_tokens = self.tokenizer(result["message"]["content"], return_tensors="pt").input_ids.shape[1]
            total_tokens = prompt_tokens + completion_tokens
    ...
    def GetEmbeddings(self, request, context):
        ...
        try:
            ...
            # Count tokens
            total_tokens = sum(self.tokenizer(text, return_tensors="pt").input_ids.shape[1] for text in inputs)
            ...
            for i, embedding in enumerate(embeddings):
                embedding_data = model_pb2.EmbeddingData(
                    embedding=embedding,
                    index=i
                )
