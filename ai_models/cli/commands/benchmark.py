...
class BenchmarkCommand(BaseCommand):
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            type=str,
            default="latency",
            choices=["latency", "throughput", "memory", "accuracy", "perplexity", "rouge"],
    ...
    def run(self) -> int:
        ...
        try:
            ...
            from ...benchmarking import (
                BenchmarkType, run_benchmark, compare_models,
            ...
            if self.args.compare_models:
                ...
                elif benchmark_type in [BenchmarkType.ACCURACY, BenchmarkType.PERPLEXITY, BenchmarkType.ROUGE]:
                    params.update({
