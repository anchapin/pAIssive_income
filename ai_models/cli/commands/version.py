...
class VersionCommand(BaseCommand):
    ...
    def _get_version(self, model_manager: ModelManager) -> int:
        ...
        print(f"  Compatible with: {', '.join(version.is_compatible_with) if version.is_compatible_with else 'None'}")
    ...
    def _check_compatibility(self, model_manager: ModelManager) -> int:
        ...
        if compatible:
            print(f"Version {self.args.version1} of model {self.args.model_id1} is compatible with "
                  f"version {self.args.version2} of model {self.args.model_id2}")
        else:
            print(f"Version {self.args.version1} of model {self.args.model_id1} is NOT compatible with "
                  f"version {self.args.version2} of model {self.args.model_id2}")
