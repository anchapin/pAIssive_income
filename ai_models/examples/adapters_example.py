...
def main():
    ...
    parser.add_argument("--adapter", type=str, choices=["ollama", "lmstudio", "openai", "tensorrt"], help="Type of adapter to test")
    ...
    parser.add_argument("--prompt", type=str, default="Hello, world!", help="Input prompt for text generation")
