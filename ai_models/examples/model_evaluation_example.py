...
from ai_models.fine_tuning import (
    EvaluationMetric, EvaluationConfig, ModelEvaluator,
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="evaluation_results", help="Directory to save the results")
    parser.add_argument("--metrics", type=str, nargs="+", default=["perplexity", "accuracy"], help="Metrics to use for evaluation")
