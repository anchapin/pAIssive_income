...
class ONNXModel:
    ...
    def load(self) -> None:
        ...
        try:
            ...
            if self.model_type in ["text-generation", "text-classification", "embedding"] and TRANSFORMERS_AVAILABLE:
            ...
            if not tokenizer_path:
                ...
                if os.path.exists(os.path.join(model_dir, "tokenizer.json")):
                    ...
                    if "gpt" in model_name.lower():
                        ...
                        logger.warning("Could not determine tokenizer. Please specify tokenizer_path.")
                        return
        ...
        **kwargs
        ...
        try:
            ...
            if kwargs.get("normalize", True):
                if TORCH_AVAILABLE:
                    embeddings = torch.nn.functional.normalize(torch.tensor(embeddings), p=2, dim=1).numpy()
                else:
