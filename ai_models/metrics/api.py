...
class MetricsAPI:
    ...
    def register_model(self,
                      ...
                      completion_cost_per_1k: float = 0.0) -> None:
        """
        ...
        logger.info(f"Registered model {model_id} with prompt cost: ${prompt_cost_per_1k}/1k, "
    ...
    def track_inference(self,
                       ...
                       tags: List[str] = None) -> EnhancedInferenceTracker:
        """
    ...
    def generate_model_dashboard(self, 
        ...
        return dashboard.generate_model_dashboard(
            model_id=model_id, 
            days=days
        )
    ...
    def get_token_usage_summary(self,
        ...
        for metric in metrics_data:
            ...
            if include_costs:
                ...
                if prompt_cost == 0.0 and completion_cost == 0.0 and current_model_id in self.registered_models:
                    rates = self.registered_models[current_model_id]
                    prompt_cost = (prompt_tokens / 1000) * rates.get("prompt_cost_per_1k", 0.0)
                    completion_cost = (completion_tokens / 1000) * rates.get("completion_cost_per_1k", 0.0)
