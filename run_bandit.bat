...
if exist bandit.yaml (
    ...
    bandit -r . -f json -o security-reports\bandit-results.json -c bandit.yaml --exclude .venv,node_modules,tests,docs,docs_source,junit,bin,dev_tools,scripts,tool_templates --exit-zero 2>nul
) else (
