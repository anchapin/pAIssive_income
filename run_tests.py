...
if __name__ == "__main__":
    ...
    print(f"Error handling tests: {'PASSED' if error_handling_result == \
        0 else 'FAILED'}")

    # Exit with appropriate code
    if all(
        result == 0
        for result in [schema_result, edge_case_result, integration_result, 
