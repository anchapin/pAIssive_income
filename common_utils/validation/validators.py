...
def validate_string(value: Any, min_length: int = None, max_length: int = None,
                    strip: bool = True) -> Tuple[bool, Optional[str]]:
    """
...
def validate_number(value: Any, min_value: float = None, max_value: float = None) -> Tuple[bool, Optional[str]]:
    """
...
def validate_list(value: Any, min_length: int = None, max_length: int = None,
                 item_validator: Callable = None) -> Tuple[bool, Optional[str]]:
    """
...
def validate_dict(value: Any, required_keys: List[str] = None,
                 key_validators: Dict[str, Callable] = None) -> Tuple[bool, Optional[str]]:
    """
...
def validate_date(value: Any, min_date: datetime = None,
                 max_date: datetime = None, format_str: str = None) -> Tuple[bool, Optional[str]]:
    """
    ...
    if min_date is not None and date_obj < min_date:
        return False, f"Date must be on or after {min_date.strftime(format_str or '%Y-%m-%d')}"
    
    if max_date is not None and date_obj > max_date:
        return False, f"Date must be on or before {max_date.strftime(format_str or '%Y-%m-%d')}"
...
def validate_regex(value: Any, pattern: str, error_message: str = None) -> Tuple[bool, Optional[str]]:
    """
