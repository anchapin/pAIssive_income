...
class CacheControls:
    ...
    def apply_policy(self, policy: Union[CachingPolicy, str]) -> None:
        ...
        if policy == CachingPolicy.DISABLED:
            ...
            critical_categories = {CacheCategory.AI_MODELS, CacheCategory.NICHE_ANALYSIS}
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "namespace_categories": {ns: cat.value for ns, cat in self.namespace_categories.items()},
