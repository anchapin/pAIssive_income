...
class CacheStatsDashboard:
    ...
    def record_event(self, event: CacheEvent) -> None:
        ...
        with self._lock:
            ...
            if event.namespace not in self._namespace_stats:
                self._namespace_stats[event.namespace] = CacheNamespaceStats(namespace=event.namespace)
    ...
    def get_stats_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            total_size_bytes = sum(stats.cache_size_bytes for stats in self._namespace_stats.values())
