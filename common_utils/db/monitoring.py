...
class MonitoringDatabaseProxy(DatabaseInterface):
    ...
    def _time_method(self, method_name: str, method: Callable, *args, **kwargs) -> Any:
        ...
        try:
            ...
            query = args[0] if len(args) > 0 and isinstance(args[0], str) else f"{method_name} operation"
    ...
    def update(self, table: str, data: Dict[str, Any], condition: str, params: Optional[Dict[str, Any]] = None) -> int:
