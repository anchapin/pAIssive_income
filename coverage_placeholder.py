...
class Calculator:
    ...
    def multiply(self, value: Union[int, float]) -> Union[int, float]:
    ...
    def divide(self, value: Union[int, float]) -> Union[int, float]:
    ...
    def power(self, value: Union[int, float]) -> Union[int, float]:
