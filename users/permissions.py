...
PERMISSIONS = {
    ...
    "monetization:view": {"name": "View Monetization Strategies", "level": PermissionLevel.VIEW},
    "monetization:create": {"name": "Create Monetization Strategies", "level": PermissionLevel.CREATE},
    "monetization:edit": {"name": "Edit Monetization Strategies", "level": PermissionLevel.EDIT},
    
    # Marketing permissions
    "marketing:view": {"name": "View Marketing Campaigns", "level": PermissionLevel.VIEW},
    "marketing:create": {"name": "Create Marketing Campaigns", "level": PermissionLevel.CREATE},
    "marketing:edit": {"name": "Edit Marketing Campaigns", "level": PermissionLevel.EDIT},
    ...
    # Admin permissions
    "admin:settings": {"name": "Manage System Settings", "level": PermissionLevel.ADMIN},
