...
class MetricSchema(BaseModel):
    ...
    target: Optional[float] = Field(default=None, description="Target value of the metric")
...
class ContentItemSchema(BaseModel):
    ...
    content_type: str = Field(..., description="Type of content (e.g., blog post, social media post)")
    ...
    assigned_to: Optional[str] = Field(default=None, description="Assignee of the content item")
    priority: PriorityLevel = Field(default=PriorityLevel.MEDIUM, description="Priority of the content item")
    keywords: List[str] = Field(default_factory=list, description="Keywords for the content item")
...
class ContentCalendarSchema(BaseModel):
    ...
    items: List[ContentItemSchema] = Field(default_factory=list, description="Content items in the calendar")
    created_at: str = Field(default_factory=lambda: datetime.now().isoformat(), description="Creation timestamp")
    updated_at: Optional[str] = Field(default=None, description="Last update timestamp")
