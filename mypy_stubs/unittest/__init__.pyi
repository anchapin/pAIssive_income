...
class TestCase:
    ...
    def assertIn(
        self, member: Any, container: Any, msg: Optional[str] = None
    ) -> None: ...
    def assertNotIn(
        self, member: Any, container: Any, msg: Optional[str] = None
    ) -> None: ...
...
class TestResult:
    ...
    def addError(
        self, test: TestCase, err: tuple[type[Exception], Exception, Any]
    ) -> None: ...
    def addFailure(
        self, test: TestCase, err: tuple[type[Exception], Exception, Any]
    ) -> None: ...
...
def main(
    module: str = "__main__",
    defaultTest: Optional[str] = None,
    argv: Optional[list[str]] = None,
    testRunner: Optional[Any] = None,
    testLoader: Optional[Any] = None,
    exit: bool = True,
    verbosity: int = 1,
    failfast: Optional[bool] = None,
    catchbreak: Optional[bool] = None,
